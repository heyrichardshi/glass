...
export type BulkUpdateTransactionsBody = z.infer<
  typeof BulkUpdateTransactionsBodySchema
>;

export const BulkUpdateTransactionsResponseSchema = z.object({
  updatedTransactions: z.array(TransactionSchema),
  failedUpdates: z.array(
    z.object({
...
export type BulkUpdateTransactionsResponse = z.infer<
  typeof BulkUpdateTransactionsResponseSchema
>;
